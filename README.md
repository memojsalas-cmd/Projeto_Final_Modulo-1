...
| **5 — Modelagem** | `LinearRegression` do scikit-learn treinado nas features escalonadas; diagnóstico de overfitting (treino x teste) (`src/modeling/train.py`) | modelo treinado |
